      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground font-mono mt-1">{formatCpfCnpj(customer.cpf_cnpj)}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {editingField === "responsavel" ? (
              <div className="flex items-center gap-1 flex-1">
                ...
                <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => saveEdit("responsavel")}>
              ...
              <div className="flex items-center gap-1 flex-1">
                ...
                <Button
                  ...
                  variant="ghost"
                  className="h-6 w-6"
                  onClick={() => startEdit("responsavel", customer.responsavel ?? "")}
                >
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              value={customer.prioridade ?? "none"}
              onValueChange={(v) => onUpdate({ prioridade: v === "none" ? null : v })}
            >
